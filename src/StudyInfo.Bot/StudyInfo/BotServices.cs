                    ...
                    case ServiceTypes.Dispatch:
                        {
                            ...
                            {
                                throw new InvalidOperationException("The Subscription Key ('AuthoringKey') is required to run this sample.  Please update your '.bot' file.");
                            }
                    ...
                    case ServiceTypes.Luis:
                        {
                            ...
                            LuisServices.Add(service.Name, recognizer);
                            break;
                        }
